...
namespace Motorcycle
{
    class ElectricBike : ICycle
    {
        ...
        public ElectricBike(string name, bool started)
        {
            if (started == true)
            {
                _Started = true;
        ...
        public void SetRpm()
        {
            ...
            Console.WriteLine("Angiv rpm. (må ikke være under 250 eller over 1500)");
            _Rpm = int.Parse(Console.ReadLine());

            if (_Rpm >= 1501 || _Rpm <= 249)
            {
